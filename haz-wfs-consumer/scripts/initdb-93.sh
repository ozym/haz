...
psql --host=127.0.0.1 --quiet --username=$db_user --dbname=hazard -f ${ddl_dir}/wfs.ddl
psql --host=127.0.0.1 --quiet --username=$db_user --dbname=hazard -f ${ddl_dir}/wfs-region.ddl
psql --host=127.0.0.1 --quiet --username=$db_user --dbname=hazard -f ${ddl_dir}/wfs-region-values.ddl
psql --host=127.0.0.1 --quiet --username=$db_user --dbname=hazard -f ${ddl_dir}/user-permissions.ddl
