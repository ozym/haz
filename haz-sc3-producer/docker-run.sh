...
#
# The SC3 site - primary or backup.
# SC3_PRODUCER_SC3_SITE=backup

docker run -e "SC3_PRODUCER_LIBRATO_USER=" -e "SC3_PRODUCER_LIBRATO_KEY=" -e "SC3_PRODUCER_LIBRATO_SOURCE=" -e "SC3_PRODUCER_LOGENTRIES_TOKEN=" -e "SC3_PRODUCER_SNS_AWS_REGION=ap-southeast-2" -e "SC3_PRODUCER_SNS_ACCESS_KEY=XXX" -e "SC3_PRODUCER_SNS_SECRET_KEY=XXX" -e "SC3_PRODUCER_SNS_TOPIC_ARN=XXX" -e "SC3_PRODUCER_SERVICE_ID=haz-sc3-producer.localhost" -e "SC3_PRODUCER_SC3_SPOOL_DIR=/work/spool" -e "SC3_PRODUCER_SC3_SITE=backup" busybox
